# Neighborhood decks: designer brief

Gus, 2026-09-24: target souvenir shops by neighborhood instead of generic Miami. Start with Wynwood, South Beach, Little Havana. Keep the Retail box layout; the box takes its colors and window picture from the card back.

Full brief with reference photos and direction sketches (share this with the designer): https://claude.ai/artifact/9wTKMB7afh9nATpbwpVxdN (private until Gus shares it from the page's Share menu).
...
## Reference photos
Carol M. Highsmith, Library of Congress, no known restrictions. Picks and 90 candidates are in the session scratchpad only; search loc.gov for "Highsmith Wynwood", "Highsmith Little Havana", "Highsmith Miami Beach".

## Studio side, when art arrives
New project per neighborhood, Retail box, `customImage` = window picture, `highlight` = big word color, `backBackground` = box color, card back uploaded as the custom back image.
